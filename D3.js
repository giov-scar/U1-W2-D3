...
console.log('Personaggi di Star Wars', characters);
/* ESERCIZIO 3
...
console.log('Personaggi femminili di Star Wars', femaleCharacters);
/* ESERCIZIO 4
...
switch (starWarsCharacters[i].eye_color) {
  case 'blue':
    eyeColor.blue.push(["name" + starWarsCharacters[i].name])
    break;

    case 'yellow':
    eyeColor.yellow.push(["name" + starWarsCharacters[i].name])
    break;

    case 'brown':
    eyeColor.brown.push(["name" + starWarsCharacters[i].name])
    break;

    case 'red':
    eyeColor.red.push(["name" + starWarsCharacters[i].name])
    break;

    case 'blue-gray':
    eyeColor["blue-gray"].push(["name" + starWarsCharacters[i].name])
    break;
}
  }
...
while(j < starWarsCharacters.length){
  crewMass += Number(starWarsCharacters[j].mass); j++
}
...
for (let i = 0; i <starWarsCharacters.length; i++){
  ...
  console.log('Riassegnazione genere', starWarsCharacters[i].gender);
}
